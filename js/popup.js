...
(function () {
  ...
  var onFindButtonSubmit = function (evt) {
  ...
  var findButtonElement = document.querySelector('.search-hotels');
  findButtonElement.addEventListener('submit', onFindButtonSubmit);
